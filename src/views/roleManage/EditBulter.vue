...
<script>
    import { getAllScene,getKeeperData,updateKeeper } from 'api/keeper'; 
    ...
    export default {
          data () {
            ...
            return {
                ...
                dataInfo:{id:null,realName:null,cellPhoneNum:null,sceneIds:[]},
                ruleValidate: {
                    realName: [
              ...
              getKeeperData(this.dataInfo.id).then(response => {
                if (response.code === '0000') {
                  ...
                  for (var i = 0; i < result.scenes.length; i++) {
                    this.dataInfo.sceneIds.push(result.scenes[i].id);                     
                  }                  
                  //this.selectKeys = this.dataInfo.sceneIds;
                }               
              }).catch(error => {
                console.log(error)
              });
